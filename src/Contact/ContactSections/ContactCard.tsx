...
function ContactCard() {
    return(
        <div className="contact-card w-[270px] h-[430px] bg-[white] rounded-[14px] overflow-hidden">
            ...
            <button className='block w-[80%] mx-auto my-[15px] bg-[#0078a4] py-[10px] text-[15px] text-white rounded-[25px] transition transition-[0.3s] hover:bg-[#0b7ea9]'>Ask your question</button>
        </div>
    )
}
