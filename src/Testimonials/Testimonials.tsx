...
function Testimonials() {
  return(
    <div className='testimonials bg-[#8eb9d8] bg-[#c2e5ff] py-[100px]'>
      <h1 className="text-center text-black text-[64px] font-bold">What patient say about Afia</h1>
      <div className='testimonials-container container mx-auto grid mt-[90px]'>
        {
          testimonials.map(testimonial => (
            <div key={testimonial.id} className='testimonial text-center bg-[#7ba4e0] rounded-[14px] h-[250px]'>
              ...
              <p className='text-white text-[25px] mt-[10px]'>{testimonial.pov}</p>
            </div>
          ))
        }
      </div>
